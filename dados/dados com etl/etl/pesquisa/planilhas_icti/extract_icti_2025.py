...
url_planilha = "https://docs.google.com/spreadsheets/d/1ybMS9G0y4cxKyd-8aG6lkJv1tdpQp4CT6LXq6knseOs/edit?gid=978827549#gid=978827549"
...
df_tratado.to_csv("data/processed/pesquisa/planilhas_icti/icti_2025.csv", index=False)
print(f"Sucesso! {len(df_tratado)} registros salvos em icti_2025.csv")