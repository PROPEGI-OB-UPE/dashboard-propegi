...
url_planilha = "https://docs.google.com/spreadsheets/d/1ZmRSnxWXVIBcKPUVyCRSRXxX3XRFtDiifqozrj1vzig/edit?gid=949989533#gid=949989533"
...
df_tratado.to_csv("data/processed/pesquisa/planilhas_icti/icti_2023_extra.csv", index=False)
print(f"Sucesso! {len(df_tratado)} registros salvos em icti_2023_extra.csv")