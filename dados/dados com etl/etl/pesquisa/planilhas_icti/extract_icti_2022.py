...
url_planilha = "https://docs.google.com/spreadsheets/d/1KDmKatrjUbLCIz1xWdKVEQj0aF7CfHc-eM5OUuJeYhg/edit?gid=1250054852#gid=1250054852"
...
df_tratado.to_csv("data/processed/pesquisa/planilhas_icti/icti_2022.csv", index=False)
print(f"Sucesso! {len(df_tratado)} registros salvos em icti_2022.csv")