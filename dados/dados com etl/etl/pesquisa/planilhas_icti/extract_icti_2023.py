...
url_planilha = "https://docs.google.com/spreadsheets/d/1JRpdWOrwWrWFnHd9JT2b5yH26q8XZSBljcfDnYeb1ZI/edit?gid=842534525#gid=842534525"
...
df_tratado.to_csv("data/processed/pesquisa/planilhas_icti/icti_2023.csv", index=False)
print(f"Sucesso! {len(df_tratado)} registros salvos em icti_2023.csv")