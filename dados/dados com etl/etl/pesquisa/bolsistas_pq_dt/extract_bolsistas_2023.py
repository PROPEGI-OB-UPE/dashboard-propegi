...
url_planilha = "https://docs.google.com/spreadsheets/d/1zb120U48qGQ5Vd_7R8sVACAcatMJjJovCSweSgyozEE/edit?gid=1221333051#gid=1221333051t"
...
# Para a planilha de 2023, o cabeçalho está na Linha 1 (índice 0)
...
caminho_csv = "data/processed/pesquisa/bolsistas_pq_dt/bolsistas_2023.csv"
df_tratado.to_csv(caminho_csv, index=False)

print(f"Sucesso! {len(df_tratado)} registros de 2023 salvos em {caminho_csv}")